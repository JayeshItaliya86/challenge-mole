...
model.add(layers.Conv2D(filters=filters, kernel_size=kernel_size, input_shape=(600,450,3), activation='relu'))
model.add(layers.Flatten())
model.add(layers.Dense(2, activation='sigmoid'))
model.compile(loss='mse', optimizer='adam', metrics=['accuracy'])
model.fit(train_img, train_labels, epochs=6, batch_size=256)
model.summary()